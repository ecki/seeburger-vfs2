...
class HttpRandomAccessContent extends AbstractRandomAccessStreamContent
{
    ...
    private final JdbcTableObject fileObject;
    private final JdbcTableFileSystem fileSystem;

    private DataInputStream dis = null;
    private MonitorInputStream mis = null;

    HttpRandomAccessContent(final JdbcTableObject fileObject, final RandomAccessMode mode)
    {
        super(mode);

        this.fileObject = fileObject;
        fileSystem = (JdbcTableFileSystem) this.fileObject.getFileSystem();
    }
...
/*
        ...
        mis = new JdbcTableObject.HttpInputStream(getMethod);
